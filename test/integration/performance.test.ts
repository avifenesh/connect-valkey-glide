...
describePerformance('Performance Integration Tests', () => {
  ...
  describe('Memory and Resource Tests', () => {
    ...
    it('should handle many small sessions vs few large sessions', async () => {
      ...
      const maxSmallSessionTime = 10000;
